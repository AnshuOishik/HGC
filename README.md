...
2. The list of target file directories and the reference file path (the first line) are both found in the file chr
...
6. Then for reference-free the 4 is the number of splits
