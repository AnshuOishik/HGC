...
class OptKmerSize{
	...
	static int seq_num, max_seq_num = 120, max_cha_num = 1 << 28, ref_code_len; //max_cha_num = 1 << 28
	static char[] ref_code;
	static int max_arr_num_bit = 28, max_arr_num = 1 << max_arr_num_bit; //max_arr_num_bit = 30
	...
	static void kMerHash(int kmer_len) {  
		...
		//System.out.println(ref_code_len+"  "+number_of_kmer);
